...
Double_t MakeCone(TPythia6 *pythia, TClonesArray *detearr, TClonesArray *pararr, Double_t pT, Double_t jetEta, Double_t jetPhi, Bool_t charged="kFALSE", Bool_t effi="kFALSE", Bool_t pTsmear="kFALSE", TString frag="u",bool fillEffHisto=false, TH1D* hTrackEff=NULL);
