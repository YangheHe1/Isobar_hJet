...
// Fri Jun  5 03:32:33 2020 by ROOT version 5.34/38
// from TTree MCTree/MCTree
// found on file: F_mixedevents_mult_0_vz_0_Psi_0.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("F_mixedevents_mult_0_vz_0_Psi_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("F_mixedevents_mult_0_vz_0_Psi_0.root");
      }
