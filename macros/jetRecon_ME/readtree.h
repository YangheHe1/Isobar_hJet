...
// Sun May 24 07:37:44 2020 by ROOT version 5.34/38
// from TTree METree/METree
// found on file: MCTree_031.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MCTree_031.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("MCTree_031.root");
      }
