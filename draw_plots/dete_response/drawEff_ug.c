...
void readin(){
    ...
    sprintf(name,"u_PtEff/pyEmb_2000k_charged_R0.2_peripheral.root");
    cout<<name<<endl;
    fin = TFile::Open(name);
    ...
    sprintf(name,"g_PtEff/pyEmb_2000k_charged_R0.2_peripheral.root");
    cout<<name<<endl;
...
void drawEffCompare(){
    ...
    hhtem[1]->SetLineWidth(1.7);
            ...
            tx0=0.50, ty0=0.80;
            myTextF(tx0,ty0,"centrality 60-80%",tsize*0.6,1,12);
            tx0=0.50;ty0=0.72;
            //sprintf(name,"centrality 0-10%");
            ...
            leg->AddEntry(hhtem[0],"u fragment","l");

            leg->AddEntry(hhtem[1],"g fragment","l");
