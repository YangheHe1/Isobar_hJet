...
*/    
    ...
    gr[0]->SetFillStyle(3002);;
            ...
            if(_form==0) hhtem[0] -> GetXaxis()->SetRangeUser(-10,10);
...
//            leg->AddEntry(gr[1],"Fill region range2","f");
    ...
    if(_form==0) hhtem[3] -> GetXaxis()->SetRangeUser(-10,10);
    ...
    TLine *t1;
    if(_form==0) t1= new TLine(-10,1,11,1);
    ...
    if(_form==0) pad[0][2]=new TPad("pad1","pad1",0.58,0.54,0.88,0.99);
